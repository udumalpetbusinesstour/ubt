      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-3 mt-1">
            ...
            <a href="https://www.instagram.com/udumalpet.business/" target="_blank" rel="noopener noreferrer" className="h-8 w-8 rounded-full border border-slate-700 hover:border-emerald-500 flex items-center justify-center hover:bg-[#027244] hover:text-white transition-all text-slate-400">
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-2.5 text-xs font-semibold text-slate-400">
            ...
            <li><Link to="/sitemap" className="hover:text-emerald-500 transition-colors">Sitemap</Link></li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-3.5 text-xs font-semibold text-slate-400">
            ...
            <li className="flex items-center gap-2.5">
              ...
              <a href="https://wa.me/918925238260" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 transition-colors">+91 89252 38260</a>
            </li>
            <li className="flex items-center gap-2.5">
