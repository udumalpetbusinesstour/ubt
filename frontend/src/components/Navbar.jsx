            ...
            {!user ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  ...
                  {showNotifications && (
                    <div className="fixed inset-x-4 top-16 sm:absolute sm:right-0 sm:left-auto sm:w-80 sm:top-auto sm:mt-2 bg-white border border-slate-200 rounded shadow-xl py-2 z-50 text-slate-800">
            ...
            <div className="flex flex-col gap-3.5 mt-2.5 pt-2.5 border-t border-slate-100">
              ...
              <div className="flex flex-col gap-2.5 text-xs font-semibold text-slate-600 mt-2">
                <div className="flex items-center gap-2">
                  ...
                  <a href="tel:+919787241221" className="hover:text-[#027244] transition-colors">+91 97872 41221</a>
                </div>
                <div className="flex items-center gap-2">
