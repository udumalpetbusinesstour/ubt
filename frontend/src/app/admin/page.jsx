        ...
        <header className="h-[76px] bg-white border-b border-slate-200/80 px-6 md:px-8 hidden md:flex items-center justify-between z-10 sticky top-0 shrink-0">
          ...
          <div className="flex items-center gap-4">
            <div className="relative" ref={notificationsRef}>
              ...
              {notificationsOpen && (
                <div className="absolute -right-28 sm:right-0 mt-2 w-72 sm:w-80 bg-white border border-slate-200 rounded-2xl shadow-xl py-3 px-4 flex flex-col gap-2.5 animate-fadeIn z-50 text-[#001c41]">
