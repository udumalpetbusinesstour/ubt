            ...
            <div className="bg-white border border-slate-200 shadow-sm rounded-3xl p-6 flex flex-col gap-5">
              ...
              <div className="flex gap-3.5 items-start">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <a href="tel:+919787241221" className="text-xs text-slate-800 font-extrabold hover:underline mt-1 leading-normal">+91 97872 41221</a>
                </div>
              </div>
                            ...
                            >
                              ...
                              <div className="shrink-0 overflow-hidden relative h-48 md:w-64 rounded-l-[23px]">
                                <div 
                                  ...
                                  style={{
                                    backgroundImage: `url('${window.getImageUrl(biz.coverImageUrl) || "https://images.unsplash.com/photo-1542838132-92c53300491e?w=500&q=80"}')`,
