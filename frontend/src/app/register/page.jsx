...
import { 
  ...
  Eye, EyeOff, Store, Users, Star, TrendingUp, Headset, MapPin, ThumbsUp, Coins,
  ...
  const renderSidebar = () => {
        ...
        <div className="order-2 lg:order-1 lg:w-[45%] bg-[#F0FDF4]/80 text-[#001c41] p-6 sm:p-10 flex flex-col justify-between relative border-b lg:border-b-0 lg:border-r border-slate-100">
            ...
            <ul className="flex flex-col gap-5 mt-6">
              {[
                ...
                { 
                  ...
                  desc: <span>List your event for just ₹99 per listing.</span>,
          ...
          <div className="hidden lg:flex z-10 mt-10 p-4 sm:p-5 rounded-2xl bg-white/70 border border-emerald-100 items-start gap-4 shadow-sm text-left">
            ...
            <div className="flex flex-col gap-0.5 text-left">
              ...
              <a href="tel:+918925238260" className="text-xs text-[#027244] font-black mt-1 hover:underline leading-none">Call: +91 89252 38260</a>
            </div>
          </div>
        </div>
      );
    ...
    if (fromParam === 'partner') {
      return (
        <div className="order-2 lg:order-1 lg:w-[45%] bg-[#F0FDF4]/80 text-[#001c41] p-6 sm:p-10 flex flex-col justify-between relative border-b lg:border-b-0 lg:border-r border-slate-100">
          <div className="flex flex-col gap-5 text-left">
            <h2 className="text-3xl font-black tracking-tight text-[#001c41]">Become a UBT Partner</h2>
            <p className="text-slate-550 text-sm font-semibold max-w-xs leading-relaxed">
            ...
            <p className="text-[13px] text-slate-505 font-bold leading-relaxed mt-4 italic border-l-2 border-emerald-500 pl-3">
