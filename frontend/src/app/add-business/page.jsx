...
export default function AddBusiness() {
  ...
  const handleAIGenerate = (field, isBranch = false) => {
  ...
  const acceptAIContent = () => {
    const { field, isBranch, content } = aiModal;
    if (isBranch) {
      setBranchForm(prev => ({
        ...prev,
        [field]: content
    ...
    setToastMessage(`${field === 'description' ? 'Description' : field === 'highlights' ? 'Highlights' : 'Services'} updated successfully!`);
